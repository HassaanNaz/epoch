...
const BackgroundCollage: React.FC<{ dimmed?: boolean }> = ({ dimmed }) => {
  const collageItems = useMemo(
    () => [
      { text: "Moon Landing", img: "/berlinwall.jpg", top: "2%", left: "-2%", rotate: "-15deg", size: "lg", aspect: "aspect-[4/5]" },
      { text: "Great Pyramid of Giza", img: "/pyramids.jpg", top: "25%", left: "-10%", rotate: "12deg", size: "lg", aspect: "aspect-[3/4]" },
      { text: "Viking Landing in North America", img: "/vikings.jpg", top: "82%", left: "1%", rotate: "9deg", size: "lg", aspect: "aspect-[4/5]" },
      { text: "Titanic Sinking", img: "titanic.jpg", top: "70%", left: "95%", rotate: "-25deg", size: "lg", aspect: "aspect-[16/10]" },
      { text: "Black Death", img: "blackdeath.jpg", top: "-8%", left: "60%", rotate: "6deg", size: "sm", aspect: "aspect-square" },
      { text: "Fall of the Berlin Wall", img: "berlinwall.jpg", top: "95%", left: "55%", rotate: "-4deg", size: "md", aspect: "aspect-[3/2]" },
      { text: "Atomic Bomb Dropped on Hiroshima", img: "bomb.jpg", top: "35%", left: "96%", rotate: "32deg", size: "sm", aspect: "aspect-[4/5]" },
      { text: "World War 1", img: "ww1.jpg", top: "60%", left: "84%", rotate: "-18deg", size: "md", aspect: "aspect-[3/4]" },
      { text: "First World Cup", img: "worldcup.jpg", top: "15%", left: "80%", rotate: "8deg", size: "md", aspect: "aspect-[4/5]" },
      { text: "Assassination of Julius Caesar", img: "jullius.jpg", top: "5%", left: "90%", rotate: "22deg", size: "lg", aspect: "aspect-square" },
      { text: "First Flight", img: "flight.jpg", top: "15%", left: "10%", rotate: "-20deg", size: "sm", aspect: "aspect-[16/9]" },
      { text: "Industrial Revolution", img: "industrial.jpg", top: "55%", left: "-6%", rotate: "14deg", size: "lg", aspect: "aspect-[3/4]" },
      { text: "World War 2", img: "ww2.jpg", top: "45%", left: "88%", rotate: "-12deg", size: "lg", aspect: "aspect-[3/4]" },
      { text: "French Revolution", img: "french.jpg", top: "92%", left: "85%", rotate: "10deg", size: "sm", aspect: "aspect-square" },
      { text: "Discovery of Penicillin", img: "discoveryof.jpg", top: "-5%", left: "32%", rotate: "5deg", size: "md", aspect: "aspect-[3/2]" },
      { text: "Declaration of Independence", img: "declaration.jpg", top: "60%", left: "12%", rotate: "-7deg", size: "lg", aspect: "aspect-square" },
    ],
    []
  );
